---
{"dg-publish":true,"permalink":"/programming/basic/algorithm/dp-1/"}
---
...
- ![1555510635702](/img/user/programming/basic/algorithm/dp-1/1555510635702.png)
- 复数的问题是否是同一个问题
- ![1555549152869](/img/user/programming/basic/algorithm/dp-1/1555549152869.png)
...
- ```js
  ...
  ```
- ![1555303439831](/img/user/programming/basic/algorithm/dp-1/1555303439831.png)
...
- ```js
  ...
  ![1555314073094](/img/user/programming/basic/algorithm/dp-1/1555314073094.png)
...
- 如果我们分析图表，那么我们的兴趣点是连续的峰和谷。
  ...
  ![1563797578411](/img/user/programming/basic/algorithm/dp-1/1563797578411.png)
...
![1564546290940](/img/user/programming/basic/algorithm/dp-1/1564546290940.png)

![1564546391268](/img/user/programming/basic/algorithm/dp-1/1564546391268.png)

![1564546627231](/img/user/programming/basic/algorithm/dp-1/1564546627231.png)

![1564546638324](/img/user/programming/basic/algorithm/dp-1/1564546638324.png)

![1564546767373](/img/user/programming/basic/algorithm/dp-1/1564546767373.png)
...
+ 不同的物品选择不同的背包即可
  ...
  ![1564155547916](/img/user/programming/basic/algorithm/dp-1/1564155547916.png)
...
+ 费用加了一维，只需状态也加一维即可。设 F[i, v, u] 表示前 i 件物品付出两种费用分别为 v 和 u 时可获得的最大价值。状态转移方程就是：
  ...
  ![1564155685943](/img/user/programming/basic/algorithm/dp-1/1564155685943.png)
