---
{"aliases":["计算机与网络"],"tags":[],"review-dates":[],"dg-publish":true,"date-created":"2022-09-03-Sat, 10:07:11 pm","date-modified":"2024-07-04-Thu, 3:48:50 pm","permalink":"/programming/basic/cs-basic/network/!network/","dgPassFrontmatter":true}
---
...
- **路由器**的用途则是用来**转发分组**的，即进行分组交换的。
  ...
  ![1550203335754](/img/user/programming/basic/cs-basic/network/!network/1550203335754.png)
...
![1550214175679](/img/user/programming/basic/cs-basic/network/!network/1550214175679.png)
...
![1550217771266](/img/user/programming/basic/cs-basic/network/!network/1550217771266.png)
...
![1550460130444](/img/user/programming/basic/cs-basic/network/!network/1550460130444.png)

(IP 地址) AND (子网掩码) =网络地址

**默认子网掩码**

![1550460231063](/img/user/programming/basic/cs-basic/network/!network/1550460231063.png)
...
![1550460273156](/img/user/programming/basic/cs-basic/network/!network/1550460273156.png)
...
![1550461231218](/img/user/programming/basic/cs-basic/network/!network/1550461231218.png)
...
![1550461341979](/img/user/programming/basic/cs-basic/network/!network/1550461341979.png)
...
![1550461713072](/img/user/programming/basic/cs-basic/network/!network/1550461713072.png)

![1550461729270](/img/user/programming/basic/cs-basic/network/!network/1550461729270.png)
...
![1550461988441](/img/user/programming/basic/cs-basic/network/!network/1550461988441.png)
...
![1550468090231](/img/user/programming/basic/cs-basic/network/!network/1550468090231.png)
...
- RIP 存在的一个问题是当网络出现**故障**时，要经过比较长的时间才能将此信息传送到所有的路由器。
  ...
  ![1550468266757](/img/user/programming/basic/cs-basic/network/!network/1550468266757.png)
...
![1550468564398](/img/user/programming/basic/cs-basic/network/!network/1550468564398.png)
...
![1550468867854](/img/user/programming/basic/cs-basic/network/!network/1550468867854.png)
...
![1550469040807](/img/user/programming/basic/cs-basic/network/!network/1550469040807.png)
...
![1550469239864](/img/user/programming/basic/cs-basic/network/!network/1550469239864.png)
...
![1550489033519](/img/user/programming/basic/cs-basic/network/!network/1550489033519.png)
...
![1550489118374](/img/user/programming/basic/cs-basic/network/!network/1550489118374.png)
...
![1550489296629](/img/user/programming/basic/cs-basic/network/!network/1550489296629.png)
...
![1550489991736](/img/user/programming/basic/cs-basic/network/!network/1550489991736.png)

### 三类端口

**熟知端口**，数值一般为 0~1023。

![1550490034447](/img/user/programming/basic/cs-basic/network/!network/1550490034447.png)

**登记端口号**，数值为 1024~49151，为没有熟知端口号的应用程序使用的。使用这个范围的端口号必须在 IANA 登记，以防止重复。

**客户端口号或短暂端口号**，数值为 49152~65535，留给客户进程选择暂时使用。

![1550490062447](/img/user/programming/basic/cs-basic/network/!network/1550490062447.png)
...
![1550490365535](/img/user/programming/basic/cs-basic/network/!network/1550490365535.png)

### UDP 的首部格式

用户数据报 UDP 有两个字段：数据字段和首部字段。首部字段有 8 个字节，由 4 个字段组成，每个字段都是两个字节。

![1550490500030](/img/user/programming/basic/cs-basic/network/!network/1550490500030.png)
...
![1550490619345](/img/user/programming/basic/cs-basic/network/!network/1550490619345.png)

![1550490696811](/img/user/programming/basic/cs-basic/network/!network/1550490696811.png)

![1550490707687](/img/user/programming/basic/cs-basic/network/!network/1550490707687.png)

![1550490730174](/img/user/programming/basic/cs-basic/network/!network/1550490730174.png)
...
![1550491105035](/img/user/programming/basic/cs-basic/network/!network/1550491105035.png)
...
![1550491176727](/img/user/programming/basic/cs-basic/network/!network/1550491176727.png)

### 可靠传输的工作原理：停止等待协议

![1550491281602](/img/user/programming/basic/cs-basic/network/!network/1550491281602.png)
...
![1550491359717](/img/user/programming/basic/cs-basic/network/!network/1550491359717.png)
...
![1550491508723](/img/user/programming/basic/cs-basic/network/!network/1550491508723.png)

![1550491536451](/img/user/programming/basic/cs-basic/network/!network/1550491536451.png)
...
![1550491581602](/img/user/programming/basic/cs-basic/network/!network/1550491581602.png)

### 连续 ARQ 协议（窗口概念）

![1550491615128](/img/user/programming/basic/cs-basic/network/!network/1550491615128.png)
...
![1550491771542](/img/user/programming/basic/cs-basic/network/!network/1550491771542.png)
...
![1550492054506](/img/user/programming/basic/cs-basic/network/!network/1550492054506.png)

![1550492075189](/img/user/programming/basic/cs-basic/network/!network/1550492075189.png)

![1550492083979](/img/user/programming/basic/cs-basic/network/!network/1550492083979.png)

![1550492091533](/img/user/programming/basic/cs-basic/network/!network/1550492091533.png)

![1550492099502](/img/user/programming/basic/cs-basic/network/!network/1550492099502.png)

### 滑动窗口例子

![1550492147653](/img/user/programming/basic/cs-basic/network/!network/1550492147653.png)

![1550492153675](/img/user/programming/basic/cs-basic/network/!network/1550492153675.png)

![1550492159269](/img/user/programming/basic/cs-basic/network/!network/1550492159269.png)

![1550492165005](/img/user/programming/basic/cs-basic/network/!network/1550492165005.png)

![1550492172540](/img/user/programming/basic/cs-basic/network/!network/1550492172540.png)

![1550492180333](/img/user/programming/basic/cs-basic/network/!network/1550492180333.png)
...
- 发送缓存用来暂时存放：
  ...
  ![1550538645827](/img/user/programming/basic/cs-basic/network/!network/1550538645827.png)
...
- 接收缓存用来暂时存放：
  ...
  ![1550538766988](/img/user/programming/basic/cs-basic/network/!network/1550538766988.png)
...
![1550538875488](/img/user/programming/basic/cs-basic/network/!network/1550538875488.png)
...
- **慢开始算法的原理**
  ...
  ![1550539244227](/img/user/programming/basic/cs-basic/network/!network/1550539244227.png)
...
- **当网络出现拥塞时**
  ...
  - 这样做的目的就是要迅速减少主机发送到网络中的分组数，使得发生拥塞的路由器有足够时间把队列中积压的分组处理完毕。
    ...
    ![1550539370259](/img/user/programming/basic/cs-basic/network/!network/1550539370259.png)
...
域名的结构由标号序列组成，各标号之间用点隔开：![1550544396814](/img/user/programming/basic/cs-basic/network/!network/1550544396814.png)
...
![1550544538831](/img/user/programming/basic/cs-basic/network/!network/1550544538831.png)
...
![1550544941060](/img/user/programming/basic/cs-basic/network/!network/1550544941060.png)
...
- 数据传送进程实际完成文件的传送，在传送完毕后关闭“数据传送连接”并结束运行。
  ...
  ![1550561858160](/img/user/programming/basic/cs-basic/network/!network/1550561858160.png)
...
![1550562157263](/img/user/programming/basic/cs-basic/network/!network/1550562157263.png)
...
![1550562373034](/img/user/programming/basic/cs-basic/network/!network/1550562373034.png)
...
- URL 的一般形式是：![1550562626077](/img/user/programming/basic/cs-basic/network/!network/1550562626077.png)
  - **冒号和两个斜线**是规定的格式
...
![1550562852920](/img/user/programming/basic/cs-basic/network/!network/1550562852920.png)
...
![1550562949961](/img/user/programming/basic/cs-basic/network/!network/1550562949961.png)
...
![1550563396152](/img/user/programming/basic/cs-basic/network/!network/1550563396152.png)
...
- TCP/IP 体系的电子邮件系统规定电子邮件地址的格式如下：
  ...
  ![1550563503264](/img/user/programming/basic/cs-basic/network/!network/1550563503264.png)

- 符号“@”读作“at”，表示“在”的意思。

  ![1550563523819](/img/user/programming/basic/cs-basic/network/!network/1550563523819.png)
...
- 邮件从新浪邮件服务器传送到 B 是使用 HTTP 协议。
  ...
  ![1550563698708](/img/user/programming/basic/cs-basic/network/!network/1550563698708.png)
