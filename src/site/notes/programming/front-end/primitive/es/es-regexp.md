---
{"dg-publish":true,"permalink":"/programming/front-end/primitive/es/es-regexp/"}
---
...
比如：
  ...
  ![string](/img/user/programming/front-end/primitive/es/es-regexp/string1.png)

注意，打印的结果中第一行是一个换行，你可以使用 trim 函数消除换行。消除后：

  ![string](/img/user/programming/front-end/primitive/es/es-regexp/string2.png)
...
如果你要消除这个逗号，你可以先 join 一下：
  ...
  ![string](/img/user/programming/front-end/primitive/es/es-regexp/string4.png)
...
![es-regexp](es-regexp.md#匹配字符的案例)

## 匹配位置的案例

![es-regexp](es-regexp.md#匹配位置的案例)
