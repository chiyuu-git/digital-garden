---
{"aliases":[],"tags":[],"review-dates":["2019-09-20","2023-04-28"],"dg-publish":true,"date-created":"2022-09-03-Sat, 10:07:31 pm","date-modified":"2023-08-24-Thu, 12:29:28 pm","permalink":"/programming/front-end/primitive/css/css-2.1/","dgPassFrontmatter":true}
---
...
- 这三个术语，“块级盒”、“块容器盒”、“块盒”在意义明确时可简称为“块”。
  ...
  ![1553073314335.png](/img/user/programming/front-end/primitive/css/css-2.1/5cee87e4d7ac396572.png)
...
![1553066995197.png](/img/user/programming/front-end/primitive/css/css-2.1/5cee882c8416580129.png)
...
- 此时会产生两个匿名块盒子：一个是 `<span>` 元素前面的文本（`Some *inline* text`），另一个是其之后的文本（`followed by more inline text.`）。此时会生成下面的块结构：
  ...
  ![1553068343611.png](/img/user/programming/front-end/primitive/css/css-2.1/5cee886f4562890560.png)
...
```
  ...
  ![1553081068612.png](/img/user/programming/front-end/primitive/css/css-2.1/5cee88b0278fd12635.png)
...
![1553082284515.png](/img/user/programming/front-end/primitive/css/css-2.1/5cee88d9bd88327277.png)
...
- 为了格式化该段落，客户端将五个行内盒放进**行盒**。在这个例子中，由 ` p ` 元素生成的盒创建了行盒的包含块。如果该包含块足够宽，所有的行内盒将放置在单个行盒：
  ...
  ![1553083952313](/img/user/programming/front-end/primitive/css/css-2.1/1553083952313.png)

- 如果宽度不够，行内盒就会被分割并分布在多个行盒。段落可能就变成了：

  ![1553083974850](/img/user/programming/front-end/primitive/css/css-2.1/1553083974850.png)
...
- 根据 ` p ` 的宽度，这些盒可能分布如下：
  ...
  ![1553084063643](/img/user/programming/front-end/primitive/css/css-2.1/1553084063643.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/31243722432787177.jpg)
...
- 浏览器渲染的时候，会比实际的 font-size 要大，30px 的字体大小，内容区本应是 30px 高度，但是被渲染成了 40px![](/img/user/programming/front-end/primitive/css/css-2.1/1548652489942.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/1557719631113.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/1557626200364.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/1557627831859.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/20190531220523.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/20190531220223.png)

- 当支柱的高度小于行内最高盒的时候，支柱撑起父容器的**角色**被最高盒代替，最高盒成为**新的支柱**，**但是**基线的位置仍然是在**初始支柱**的小写字母 x 的下边缘

![](/img/user/programming/front-end/primitive/css/css-2.1/20190531220041.png)
...
- 在上面的定义中，对行内不可替换元素而言，用于对齐的行内级盒是高度为 `line-height` 的盒（**不**包括行内盒的内容区）
  ...
  > 只有基线对齐是依赖于行内盒的基线，其他全都是根据 line-height 盒
  >
...
2. 行内级盒根据其 `vertical-align` 属性垂直对齐。
   ...
   - 假如没有图片，无论父元素的 font-size 怎么变化，行高都不收影响，如果有图片，会被图片的对齐方式影响行高
     ...
     ![1557637961740](/img/user/programming/front-end/primitive/css/css-2.1/1557637961740.png)

3. **行盒**高度是最上盒顶部到最下盒底部的距离。（包括支柱）

   ![1557722129003](/img/user/programming/front-end/primitive/css/css-2.1/1557722129003.png)
...
- 空行内元素生成空行内盒，但这些盒仍然有外边距、内边距、边框和一个行高，因此跟有内容的元素一样会影响计算。
  ...
  ![1557723773875](/img/user/programming/front-end/primitive/css/css-2.1/1557723773875.png)
...
![1557722701927](/img/user/programming/front-end/primitive/css/css-2.1/1557722701927.png)

![1557717139077](/img/user/programming/front-end/primitive/css/css-2.1/1557717139077.png)
...
![1559096116352](/img/user/programming/front-end/primitive/css/css-2.1/1559096116352.png)
...
![1557640161117](/img/user/programming/front-end/primitive/css/css-2.1/1557640161117.png)
...
![1557713705205](/img/user/programming/front-end/primitive/css/css-2.1/1557713705205.png)
...
![1557570724729](/img/user/programming/front-end/primitive/css/css-2.1/1557570724729.png)

![1557570768007](/img/user/programming/front-end/primitive/css/css-2.1/1557570768007.png)

### 多行文本垂直水平居中

![1557581435771](/img/user/programming/front-end/primitive/css/css-2.1/1557581435771.png)
...
![](/img/user/programming/front-end/primitive/css/css-2.1/2022-06-01-15-05-12.png)
